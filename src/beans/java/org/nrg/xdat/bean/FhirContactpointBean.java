...
public class FhirContactpointBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.FhirContactpointI {
	public static final Logger logger = Logger.getLogger(FhirContactpointBean.class);
	...
	public void setDataField(String xmlPath,String v) throws BaseElement.UnknownFieldException{
		if (xmlPath.equals("system")){
			...
			setValue(v);
		}else if (xmlPath.equals("use")){
			setUse(v);
		}else if (xmlPath.equals("rank")){
			setRank(v);
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_Rank!=null){
			writer.write("\n" + createHeader(header++) + "<fhir:rank");
			writer.write(">");
			writer.write(ValueParser(_Rank,"positiveInteger"));
			writer.write("</fhir:rank>");
			header--;
		}
			int child0=0;
			int att0=0;
