...
public class FhirPatientLinkBean extends BaseElement implements java.io.Serializable, org.nrg.xdat.model.FhirPatientLinkI {
	public static final Logger logger = Logger.getLogger(FhirPatientLinkBean.class);
	...
	protected boolean addXMLBody(java.io.Writer writer, int header) throws java.io.IOException{
		...
		if (_OtherId!=null){
			writer.write("\n" + createHeader(header++) + "<fhir:other_ID");
			writer.write(">");
			writer.write(ValueParser(_OtherId,"integer"));
			writer.write("</fhir:other_ID>");
			header--;
		}
		else{
			writer.write("\n" + createHeader(header++) + "<fhir:other_ID");
	...
	protected boolean hasXMLBodyContent(){
		if (_OtherId!=null) return true;
		return true;//REQUIRED other_ID
	}
}
