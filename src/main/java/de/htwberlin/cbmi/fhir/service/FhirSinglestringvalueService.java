...
public class FhirSinglestringvalueService extends ComplexDatatypeValidatable {
     ...
     * @return new object
     */
    public FhirSinglestringvalueI createSinglestringvalue(Map<String, Object> data, UserI user) {
        ...
        try {
            ...
            FhirSinglestringvalue result = new FhirSinglestringvalue(user);
     ...
     */
    @Nullable
    public Map<String, Object> makePropertyMap(FhirSinglestringvalueI entity, UserI user) {
    ...
    public Collection<String> getAllowedKeys() {
        return Datatypes.makeList("value");
    }
    ...
    public Collection<? extends Object> getAllowedKeyTypes() {
        return Datatypes.makeList(String.class);
    }
