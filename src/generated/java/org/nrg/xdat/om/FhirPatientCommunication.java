...
public class FhirPatientCommunication extends BaseFhirPatientCommunication {

	public FhirPatientCommunication(ItemI item)
	{
		super(item);
	}

	public FhirPatientCommunication(UserI user)
	{
		super(user);
	}
	...
	public FhirPatientCommunication(Hashtable properties, UserI user)
	{
