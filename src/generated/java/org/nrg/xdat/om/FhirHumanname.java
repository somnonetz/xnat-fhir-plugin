...
public class FhirHumanname extends BaseFhirHumanname {

	public FhirHumanname(ItemI item)
	{
		super(item);
	}

	public FhirHumanname(UserI user)
	{
		super(user);
	}
	...
	public FhirHumanname(Hashtable properties, UserI user)
	{
